...
public class ReminderManagementServiceBean implements ReminderManagementService {
    ...
    @Override
    public Reminder createReminder(AServer server, AChannel aChannel, AUserInAServer aUserInAServer, AUser aUser, String text, Instant timeToBeRemindedAt, Long messageId, Boolean sendInDms, Boolean userCommand) {
        Reminder reminder = Reminder.builder()
                .channel(aChannel)
                .server(server)
                .remindedUser(aUserInAServer)
                .remindedAUser(aUser)
                .sendInDm(sendInDms)
                .reminded(false)
                .text(text)
