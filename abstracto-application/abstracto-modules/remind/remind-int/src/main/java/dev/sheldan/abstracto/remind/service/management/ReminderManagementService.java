...
public interface ReminderManagementService {
    Reminder createReminder(AServer server, AChannel aChannel, AUserInAServer aUserInAServer, AUser aUser, String text, Instant timeToBeRemindedAt, Long messageId, Boolean sendInDms, Boolean userCommand);
